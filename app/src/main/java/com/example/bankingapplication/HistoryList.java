...
public class HistoryList extends AppCompatActivity {
    ...
    private void showData() {
        ...
        Cursor cursor = new com.example.bankingapplication.DataBaseHelper(this).readtransferdata();
        ...
        adapter = new CustomAdapterHistory(HistoryList.this, modelList_historylist);
