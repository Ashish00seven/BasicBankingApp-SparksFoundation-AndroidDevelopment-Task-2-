...
public class CustomAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.example.bankingapplication.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomAdapterHistory(com.example.bankingapplication.HistoryList historyList, List<Model> modelList) {
